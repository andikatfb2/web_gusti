(function ($) {
        ...
        function plothover(event, pos, item) {
            ...
            if (item) {
                ...
                $.each(plot.getData(), function (i, series) {
                    ...
                    // Our search here assumes our psb is sorted via the x-axis.
                    // TODO: Improve efficiency somehow - search smaller sets of psb.
    ...
    FlotTooltip.prototype.stringFormat = function (content, item) {
        ...
        // for threshold plugin we need to read psb from different place
